...
// update 2019.08.30 Ver.2.3.3.1 (1) Bugfix USB_Serial FT230X.And Merge driver/usb/serial for kernel v3.2.102. (ftdi_sio.c and )
//#define MC341LAN2 (1)
#define MC341
#ifndef MC341
/*
...
// update 2019.08.30
#define CPS_KERNEL_VERSION "Ver.2.3.3.1 (build: 2019.08.30) "
